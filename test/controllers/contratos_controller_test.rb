...
class ContratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post contratos_url, params: { contrato: { data: @contrato.data, desc: @contrato.desc, n_contrato: @contrato.n_contrato, n_proc_lic: @contrato.n_proc_lic } }
    end
  ...
  test "should update contrato" do
    patch contrato_url(@contrato), params: { contrato: { data: @contrato.data, desc: @contrato.desc, n_contrato: @contrato.n_contrato, n_proc_lic: @contrato.n_proc_lic } }
